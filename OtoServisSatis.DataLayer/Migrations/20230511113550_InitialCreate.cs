...
namespace OtoServisSatis.DataLayer.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2023, 5, 11, 14, 35, 50, 479, DateTimeKind.Local).AddTicks(991), "admin@otoservissatis.tc", "admin", 1, "123456", "admin", "0850" });
